...
export default function Home() {
  ...
  return (
    <>
      <div className='w-[100vw] h-[92vh] bg-[url("https://www.shutterstock.com/image-photo/dark-graphite-grey-abstract-textured-600nw-2186292063.jpg")] bg-no-repeat bg-cover bg-center'>
        <div className='md:w-[30%] rounded bg-white sm:w-[50%] flex flex-col w-[90%] m-auto'>
          <h1 className='m-auto text-3xl mt-[15%] font-bold'>Upload new Image</h1>
          <div className='p-2 mt-0  text-black gap-5 flex flex-col pl-10'>
            <p className=''>Write your Image Name here</p>
            <input type="text" value={body} onChange={(e) => setBody(e.target.value)} placeholder='write a name...' className='bg-white text-black border-2 border-gray-400 w-[95%] rounded-md h-[40px]' />
